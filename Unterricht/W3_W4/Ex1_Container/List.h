...
#ifndef EX1_CONTAINER_LIST_H
#define EX1_CONTAINER_LIST_H
...
public:
    ...
    void addElement(T value) override;
    void insertElement(T value, int index) override;
    T get(int index) const override;
    void set(T value, int index) override;
    int searchElement(T value, int startPos = 0) override; //NOLINT
    bool deleteElement(int index) override;
